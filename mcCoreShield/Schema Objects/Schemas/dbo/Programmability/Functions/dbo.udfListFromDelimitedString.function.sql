CREATE FUNCTION dbo.udfListFromDelimitedString ( 
...
/*
***************************************************************************
Procedure:     	udfListFromDelimitedString
Implemented By: DSCXN, ccarson ( not the author, see ABSTRACT )
Date:          	2011-12-01
...
-----------  -----------  ----------------------------
Chris Carson 2011-12-01	  implemented function
****************************************************************************
...
*/
	WITH  E1(N) AS (
		  ...
		  En(N) AS (SELECT TOP (DATALENGTH(ISNULL(@pString,1))) 1 FROM E8 ),  
